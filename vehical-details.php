...
if(isset($_POST['submit']))
{
  ...
  if($query1->rowCount()==0)
  {
    ...
    $sql = "INSERT INTO tblbooking(userEmail, VehicleId, FromDate, ToDate, message, Status, InsuranceIncluded, TotalPrice) 
            VALUES(:useremail, :vhid, :fromdate, :todate, :message, :status, :seguro, :totalPrice)";
...
?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Compartilhe: <a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
        </div>
