...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['updateprofile'])) {
    ...
    if (empty($cpf) && empty($cnpj)) {
      $msg = "Você deve preencher o CPF ou o CNPJ.";
    } else {
      $name = $_POST['fullname'];
      ...
      $sql = "update tblusers set FullName=:name, ContactNo=:mobileno, dob=:dob, Address=:adress, City=:city, State=:state, Country=:country, CPF=:cpf, CNPJ=:cnpj where EmailId=:email";
  ...
  if ($query->rowCount() > 0) {
    foreach ($results as $result) { ?>
                ...
                <div class="profile_wrap">
                  ...
                  <form method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control white_bg" name="cpf" value="<?php echo htmlentities($result->CPF); ?>" id="cpf" type="text">
                    </div>

                    <div class="form-group">
                      <label class="control-label">CNPJ</label>
                      <input class="form-control white_bg" name="cnpj" value="<?php echo htmlentities($result->CNPJ); ?>" id="cnpj" type="text">
                    </div>
      ...
      <<!--Footer -->
        ...
        <!-- Aplicar máscara aos campos CPF e CNPJ -->
        <script>
