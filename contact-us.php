...
if (isset($_POST['send'])) {
  ...
  if ($lastInsertId) {
    $msg = "Mensagem enviada! Retornaremos o mais rápido possível";
  } else {
  ...
  <<!-- Start Switcher -->
    ...
    <section class="contact_us section-padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h3>Entre em contato usando o formulário abaixo</h3>
            ...
            <div class="contact_form gray-bg">
              <form method="post">
                <div class="form-group">
                  <label class="control-label">Nome Completo <span>*</span></label>
